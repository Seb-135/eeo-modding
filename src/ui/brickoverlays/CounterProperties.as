package ui.brickoverlays
{
	...
	public class CounterProperties extends PropertiesBackground{
		public function CounterProperties(){
			
			var text1:String = "Points rewarded:";
			var text2:String = "Colour:";

			var id:Sprite = createPointScroller(text1, "counter_value", -99, +99, false)
			id.y = -39-25
